...
<div class="px-4 pt-5 my-5 text-center border-bottom pb-5 pb-md-0">
  ...
  <div class="overflow-hidden mt-5 pt-5 d-none d-md-block" style="max-height: 350px;">
    <div class="container px-5">
      <img src="https://placehold.co/1920x1080/png" class="img-fluid border rounded-3 shadow-lg mb-4" alt="" width="700" height="500" loading="lazy">
    </div>
  </div>
</div>