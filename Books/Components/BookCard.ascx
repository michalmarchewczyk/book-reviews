...
<section class="card mb-3 overflow-hidden row g-0 mh-100 w-100 comp-BookCard-card">
    ...
    <section class="col-sm-9 card-body d-flex flex-column h-100">
        ...
        <p class="card-text">
            <span class="text-muted">Średnia ocena: </span>
            <span class="fs-5"><%: Book.AverageRating == null ? "brak recenzji" : ((double)Book.AverageRating).ToString("F2") %></span>
        </p>
    </section>
</section>