...
<div class="card mb-3 overflow-hidden row g-0 mh-100 w-100" style="max-width: 780px; max-height: 260px; height: 260px;">
    ...
    <div class="col-sm-9 card-body d-flex flex-column h-100">
        ...
        <p class="card-text flex-grow-1 overflow-hidden bottom-fade mt-2 text-break" style="white-space: break-spaces;"><%: Book.Description %><%= string.IsNullOrEmpty(Book.Description) ? "<span class='fst-italic'>Brak opisu.</span>" : "" %></p>
