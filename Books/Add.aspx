...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="card">
        ...
        <asp:SqlDataSource
            ...
            SelectCommand="SELECT [Id], [Title], [AuthorId], [Description], [ISBN], [Cover], [ReleaseYear] FROM [Books]"
            UpdateCommand="UPDATE [Books] SET [Title] = @Title, [AuthorId] = @AuthorId, [Description] = @Description, [ISBN] = @ISBN, [Cover] = @Cover, [ReleaseYear] = @ReleaseYear WHERE [Id] = @Id">
            <%-- <DeleteParameters> --%>
            <%--     <asp:Parameter Name="Id" Type="Int32" /> --%>
            <%-- </DeleteParameters> --%>
            <InsertParameters>
